...
if len(sys.argv) < 2:
    raise Exception("Please specify target file")

# target_file = "2022-12-07-0300-2t"
target_file = sys.argv[1]

gcs_uri = "gs://gcs-video-tracking/{}.mp4".format(target_file)
output_uri = "gs://gcs-video-tracking/{}.json".format(target_file)

video_client = videointelligence.VideoIntelligenceServiceClient.from_service_account_file(
    "/workspace/video-tracking/cred.json")
